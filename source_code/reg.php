...
<div class="center">
  ...
  <div class="login">
    ...
    <label>
        <div class="fa fa-commenting"></div>
        <input class="text" type="text" autocomplete="off" name="username" id="name" placeholder="name"/>
        
      </label>
      <label>
        <div class="fa fa-commenting"></div>
        <input class="text" type="text" autocomplete="off" name="name" id="username" placeholder="username"/>
